...
public class TelegramBotCommands {
    ...
    public static void commandReceived(TelegramBot bot, Update update) throws TelegramApiException {
        String cmd = "";
        String userName = "";
        String languageCode = "";
        ...
        logger.info("Command received from " + StringEscapeUtils.escapeJava(userName) + ":"
    ...
    private static void bookSearch(TelegramBot bot, Update update, String searchQuery) throws TelegramApiException {
        bot.sendBusy(update);
    ...
    private static void bookSearchNext(TelegramBot bot, Update update, int searchId, int currentPage) throws TelegramApiException {
        bot.sendBusy(update);
